...
%     end
    ...
    switch ( quadorder ) 
      ...
      case 8
        ...
        otherwise
            disp('yyyyyyyyyyyyyyyyyyyyeeeeeeeeeeeeessssssssssssssss')
            [W,Q] = disBlendingQ4quad(quadorder,nodes); 
            return
  ...
  elseif ( strcmp(qt,'TRIANGULAR') == 1 ) 
    ...
    elseif ( strcmp(qt,'DUNAVANT') == 1 ) 
        
    if ( sdim == 3 )  %%% TETRAHEDRA
   disp ('not yet coded');
    else        
         [quadpoint,quadweight] = dunavant_rule (quadorder );
